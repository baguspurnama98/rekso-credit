<template>
  <div class="p-1.5 border rounded-lg overflow-x-auto md:overflow-hidden w-full mt-8">
    <h1 class="font-bold p-2 text-xl text-center">Perhitungan KUM</h1>
...
export default {
  ...
  fetch() {
    this.$axios
      .$get(
        `https://sheets.googleapis.com/v4/spreadsheets/1SWikQcKkDgSTXOUW8JD2b4qcOSTlkEGYh6XE9fS7aL8/values/SukuBunga!A53:E64?key=AIzaSyBSWyF6kNY2qB4KklKubjos4u_hNIOFx_I`
      )
      .then((resp) => {

...
- `<CreditContentCC>` | `<credit-content-c-c>` (components/credit/ContentCC.vue)
- `<CreditContentKPR>` | `<credit-content-k-p-r>` (components/credit/ContentKPR.vue)
- `<CreditContentKSM>` | `<credit-content-k-s-m>` (components/credit/ContentKSM.vue)
- `<CreditContentKUM>` | `<credit-content-k-u-m>` (components/credit/ContentKUM.vue)
- `<CreditContentKUR>` | `<credit-content-k-u-r>` (components/credit/ContentKUR.vue)
